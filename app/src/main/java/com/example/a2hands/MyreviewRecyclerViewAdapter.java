...
import com.example.a2hands.reviewFragment.OnListFragmentInteractionListener;
...
public class MyreviewRecyclerViewAdapter extends RecyclerView.Adapter<MyreviewRecyclerViewAdapter.ViewHolder> {
    ...
    public MyreviewRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
